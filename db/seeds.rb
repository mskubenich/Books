...
100.times do |i|
  Visit.create(ip: ip_address, browser: browsers[rand(2)], browser_version: browser_versions, os_name: os_names[rand(5)], os_version: os_versions[rand(2)], device: "Computer",
