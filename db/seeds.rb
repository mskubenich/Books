...
devices = ['Computer', 'Android', 'IOS', 'Windows Phone']
ip_address = "#{rand(255)}.#{rand(255)}.#{rand(255)}.#{rand(255)}"
browser_versions = "#{rand(99)}.#{rand(10)}.#{rand(3000)}.#{rand(99)}"

100.times do |i|
  Visit.create(ip: ip_address, browser: browsers[rand(6)], browser_version: browser_versions, os_name: os_names[rand(5)], os_version: os_versions[rand(2)], device: devices[rand(5)],
